package a.manprit.statusdownloader;
...
import a.manprit.statusdownloader.Adapter.PageAdapter;
import a.manprit.statusdownloader.R;
import a.manprit.statusdownloader.Utils.Common;
...
//        getLatestAppVersion.execute();
        ...
        Toast.makeText(MainActivity.this, "by Manprit", Toast.LENGTH_LONG).show();
